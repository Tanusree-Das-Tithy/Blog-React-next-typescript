...
const boxNav = " flex float-right ml-10 sm:ml-24 p-2 align-middle mt-4 white ";

export default function Footer() {
	return (
		<div className="flex justify-center float-right gap-6 box-border mt-3 h-24 bg-black  p-4 border-1 space-x-2 sm:space-x-8 w-full">
